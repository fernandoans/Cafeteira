...
/**
 * Versao para o cafeteira do JButton
 * 
 * @author Fernando Anselmo
 * @version 1.0
 */
public class CafButton extends JButton {
   ...
   * 
   * @param titulo  String contendo o "text" para o CafButton
   * @param recModi Janela principal
   */
  public CafButton(String titulo, Principal recModi) {
    frmModi = recModi;
    this.setText(titulo);
    selected = false;
    resizing = true;
