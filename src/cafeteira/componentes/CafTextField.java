...
/**
 * Versao para o cafeteira do JTextField
 * 
 * @author Fernando Anselmo
 * @version 1.0
 */
public class CafTextField extends JTextField {
   ...
   * 
   * @param titulo  String contendo o "text" para o CafTextField
   * @param recModi Janela principal
   */
  public CafTextField(String titulo, Principal recModi) {
    frmModi = recModi;
    this.setText(titulo);
    selected = false;
    resizing = true;
