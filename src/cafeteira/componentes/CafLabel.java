...
/**
 * Versao para o cafeteira do JLabel
 * 
 * @author Fernando Anselmo
 * @version 1.0
 */
public class CafLabel extends JLabel {
   ...
   * 
   * @param titulo  String contendo o "text" para o CafLabel
   * @param recModi Janela principal
   */
  public CafLabel(String titulo, Principal recModi) {
    frmModi = recModi;
    this.setText(titulo);
    selected = false;
    resizing = true;
