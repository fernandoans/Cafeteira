...
/**
 * Versao para o cafeteira do JCheckBox
 * 
 * @author Fernando Anselmo
 * @version 1.0
 */
public class CafCheckBox extends JCheckBox {
   ...
   * 
   * @param titulo  String contendo o "text" para o CafCheckBox
   * @param recModi Janela principal
   */
  public CafCheckBox(String titulo, Principal recModi) {
    frmModi = recModi;
    this.setText(titulo);
    selected = false;
    resizing = true;
