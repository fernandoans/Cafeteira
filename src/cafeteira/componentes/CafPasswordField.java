...
/**
 * Versao para o cafeteira do JPasswordField
 * 
 * @author Fernando Anselmo
 * @version 1.0
 */
public class CafPasswordField extends JPasswordField {
   ...
   * 
   * @param titulo  String contendo o "text" para o CafPasswordField
   * @param recModi Janela principal
   */
  public CafPasswordField(String titulo, Principal recModi) {
    frmModi = recModi;
    this.setText(titulo);
    selected = false;
    resizing = true;
